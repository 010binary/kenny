  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col lg:flex-row justify-between items-start mb-8">
        ...
        <p className="text-right text-[#344A77]">
          sit cursus massa non laoreet lobortis, Cras <br/>est. placerat tincidunt volutpat<br />
          non, nisi id nisi non eu volutpat dui<br/> felis, nec amet, laoreet ex in amet,<br />
